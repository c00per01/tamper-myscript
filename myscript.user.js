...
(function () {
    ...
    const DEFAULT_TEMPLATES = {
        '��������': 'com., dsp, puzzle, game, teskin',
        '���������': 'com., android, ios, app, mobile',
        '����': 'game, puzzle, play, casino, slot'
    };
    ...
    function selectPlacements() {
        ...
        showNotification(`��������: ${count}`, 'success');
        updateStats();
        saveCurrentFilters();
    }
    ...
    function updatePreview() {
        ...
        if (previewEl) {
            previewEl.textContent = count > 0 ? `����� ��������: ${count}` : '��� ����������';
    ...
    function createControlPanel() {
        ...
        panel.innerHTML = `
            ...
            <div class="yd-pl-header" id="yd-pl-panel-header">
                <div class="yd-pl-header-left">
                    ...
                    <div class="yd-pl-title-group">
                        ...
                        <span class="yd-pl-subtitle">��������</span>
                    </div>
                </div>
                <div class="yd-pl-header-right">
                    <span id="yd-pl-stats" class="yd-pl-badge">0 / 0</span>
                    <button id="yd-pl-help-btn" class="yd-pl-icon-btn" title="�������">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="10"/>
                            <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/>
                            <line x1="12" y1="17" x2="12.01" y2="17"/>
                    ...
                    <button id="yd-pl-panel-toggle" class="yd-pl-icon-btn" title="��������">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <line x1="5" y1="12" x2="19" y2="12"/>
                        </svg>
                    </button>
            ...
            <div id="yd-pl-panel-body" class="yd-pl-body">
                ...
                <div class="yd-pl-section">
                    <div class="yd-pl-section-header">
                        <span class="yd-pl-section-label">�������</span>
                        <div class="yd-pl-section-actions">
                            <button id="yd-pl-template-save" class="yd-pl-icon-btn-sm" title="��������� ������� ��������� ��� ������">
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <button id="yd-pl-template-delete" class="yd-pl-icon-btn-sm" title="������� ������">
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <polyline points="3 6 5 6 21 6"/>
                                    <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>
                                </svg>
                ...
                <div class="yd-pl-section">
                    <div class="yd-pl-section-header">
                        <span class="yd-pl-section-label">�������</span>
                        <button id="yd-pl-reset-filters" class="yd-pl-icon-btn-sm" title="�������� ��� �������">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="yd-pl-field-group">
                        <label class="yd-pl-label-sm">�������� �������</label>
                    ...
                    <div class="yd-pl-mode-row">
                        <span class="yd-pl-label-sm">�������:</span>
                ...
                <!-- ������������ -->
                <div id="yd-pl-preview" class="yd-pl-preview">������� �������...</div>
            </div>
            ...
            <div class="yd-pl-footer">
                ...
                <button id="yd-pl-clear" class="yd-pl-btn-secondary" title="����� ��� �������">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <line x1="18" y1="6" x2="6" y2="18"/>
                        <line x1="6" y1="6" x2="18" y2="18"/>
                    </svg>
            ...
            <div id="yd-pl-help-tooltip" class="yd-pl-help-tooltip" style="display:none;">
                <div class="yd-pl-help-title">������� �������</div>
                <div class="yd-pl-help-row"><kbd>Alt+P</kbd> � �������� �� ��������</div>
                <div class="yd-pl-help-row"><kbd>Alt+Shift+P</kbd> � ����� ��� �������</div>
                <div class="yd-pl-help-divider"></div>
                <div class="yd-pl-help-row">com. � ������ � ������ ������</div>
                <div class="yd-pl-help-row">dsp � ��������� � ����� �����</div>
            </div>
