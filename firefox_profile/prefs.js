...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1763608617);
user_pref("app.update.lastUpdateTime.background-update-timer", 1763608617);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1763608617);
user_pref("app.update.lastUpdateTime.region-update-timer", 1763608617);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1763608617);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1763608617);
user_pref("app.update.migrated.updateDir3.6C6CA9390033F0CF", true);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "24a9c5e3-8dfd-45fd-bc53-50fff44f59b6");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1763608587);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{a6b8aa78-66fb-4588-a5a2-8d593cac5d0c}");
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20251001182749");
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", 2);
user_pref("browser.startup.homepage", "about:blank");
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1768582737);
...
user_pref("browser.uiCustomization.state", "{\"placements\":{\"widget-overflow-fixed-list\":[],\"unified-extensions-area\":[\"firefox_tampermonkey_net-browser-action\"],\"nav-bar\":[\"back-button\",\"forward-button\",\"stop-reload-button\",\"customizableui-special-spring1\",\"vertical-spacer\",\"urlbar-container\",\"customizableui-special-spring2\",\"downloads-button\",\"fxa-toolbar-menu-button\",\"unified-extensions-button\"],\"toolbar-menubar\":[\"menubar-items\"],\"TabsToolbar\":[\"firefox-view-button\",\"tabbrowser-tabs\",\"new-tab-button\",\"alltabs-button\"],\"vertical-tabs\":[],\"PersonalToolbar\":[\"personal-bookmarks\"]},\"seen\":[\"developer-button\",\"screenshot-button\",\"firefox_tampermonkey_net-browser-action\"],\"dirtyAreaCache\":[\"nav-bar\",\"vertical-tabs\",\"unified-extensions-area\",\"toolbar-menubar\",\"TabsToolbar\",\"PersonalToolbar\"],\"currentVersion\":23,\"newElementCount\":2}");
...
user_pref("captchadetection.lastSubmission", 1763608);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "e1ef48f6-d751-461f-9f59-f2f684423004");
user_pref("datareporting.dau.cachedUsageProfileID", "b2a4600f-aa5d-43cd-8225-199919d54497");
...
user_pref("extensions.lastAppBuildId", "20251001182749");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"4210ee93-8b2f-4c69-ad5c-bba73bb8bdac\",\"newtab@mozilla.org\":\"70d71cc1-e0d6-4508-a03a-349ce5089ade\",\"pictureinpicture@mozilla.org\":\"95902e42-5587-41bd-9871-5b84ee196f5e\",\"addons-search-detection@mozilla.com\":\"b06e2291-5a7b-4528-aa8d-820e1472ccfc\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"default-theme@mozilla.org\":\"f0b8f415-c4b8-48d2-b9c8-8a085ceaaaf2\",\"firefox@tampermonkey.net\":\"c00e4dcf-7dff-4ab2-8cb4-9944b690efdc\"}");
...
user_pref("gfx-shader-check.build-version", "20251001182749");
user_pref("gfx-shader-check.device-id", "0x1681");
user_pref("gfx-shader-check.driver-version", "30.0.14064.17001");
...
user_pref("nimbus.profileId", "f4a9f42e-cf01-4cc7-92de-dba5b981a98e");
...
user_pref("sanity-test.driver-version", "30.0.14064.17001");
user_pref("sanity-test.running", false);
user_pref("sanity-test.version", "20251001182749");
...
user_pref("toolkit.profiles.storeID", "d2199b75");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1768582735);
...
user_pref("toolkit.telemetry.previousBuildID", "20251001182749");
